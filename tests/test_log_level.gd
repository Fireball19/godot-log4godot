...
func test_from_string_valid_levels() -> void:
...
func test_from_string_invalid_level() -> void:
...
func test_level_to_string() -> void:
...
func test_level_to_string_invalid() -> void:
	# Test with invalid enum value (should return UNKNOWN)
	@warning_ignore("int_as_enum_without_match")
	assert_str(LogLevel.level_to_string(99 as LogLevel.Level)).is_equal("UNKNOWN")
...
func test_get_color_invalid() -> void:
	...
	@warning_ignore("int_as_enum_without_match")
	assert_object(LogLevel.get_color(99 as LogLevel.Level)).is_equal(Color.WHITE)

# Test level names constant
func test_level_names_constant() -> void:
...
func test_level_colors_constant() -> void:
